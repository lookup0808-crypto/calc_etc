...
export default function InputFormExample() {
  ...
  const [income, setIncome] = useState<number | "">(4000000);
  const [savingRate, setSavingRate] = useState<number | "">(0.3);
  const [targetAssets, setTargetAssets] = useState<number | "">(1300000000);
